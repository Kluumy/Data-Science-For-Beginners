...
|----------------|---------|-----------------------|-----------------------|--------------------------------------|
| Education | Are kids going to school to learn and grow? | How many kids can really do work alone? | Schemas | Making clubs for kids where they can learn something they want and not loosing their time |
| Vaccination | | | | |
| Productivity | | | | |
